...
export default function ReportsPageError({
  ...
  useEffect(() => {
    console.error('[ReportsPageError]', error);
  }, [error]);
  ...
  return (
    ...
    >
      <div className="glass-card w-full max-w-md rounded-xl p-8 text-center">
        ...
        <h2 className="mb-2 text-xl font-semibold">Reports failed to load</h2>

        <p className="mb-6 text-sm text-muted-foreground">
          {error.message || 'Could not load status reports. Please try again.'}
        </p>
