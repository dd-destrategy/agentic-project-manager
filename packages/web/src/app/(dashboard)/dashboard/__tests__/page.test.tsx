...
vi.mock('@/components/escalation-banner', () => ({
  EscalationBanner: () => <div data-testid="escalation-banner">Escalation Banner</div>,
}))
...
describe('Dashboard Page', () => {
  ...
  it('displays page title and description', () => {
    ...
    expect(screen.getByText(/real-time agent monitoring and project health/i)).toBeInTheDocument()
  })
