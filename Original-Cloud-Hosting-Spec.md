...
```
┌─────────────────────────────────────────────────────────────┐
│  Claude PM Workbench                    [User: Damien] [⚙️]  │
├─────────────────────────────────────────────────────────────┤
│                                                               │
│  📊 Active Projects (3)                                      │
│  ┌────────────────┬────────────────┬────────────────┐       │
│  │ My Career      │ BCM Website    │ QRIDA Security │       │
│  │ Universe       │ Refresh        │ Uplift         │       │
│  │                │                │                │       │
│  │ 🟡 Amber       │ 🟢 Green       │ 🔴 Red         │       │
│  │ 2 pending      │ 0 pending      │ 5 pending      │       │
│  │ Last: 15m ago  │ Last: 2h ago   │ Last: 5m ago   │       │
│  └────────────────┴────────────────┴────────────────┘       │
│                                                               │
│  ⚠️  Pending Approval (7)                                    │
│  ┌─────────────────────────────────────────────────────┐   │
│  │ 🔴 P0 - API Vendor EOL Risk Escalation              │   │
│  │     My Career Universe • 15m ago                     │   │
│  │     [Review Brief] [Approve] [Reject]                │   │
│  ├─────────────────────────────────────────────────────┤   │
│  │ 🟡 P1 - Exec Status Report (2025-02-03)             │   │
│  │     My Career Universe • 2h ago                      │   │
│  │     [Review Report] [Approve] [Edit & Approve]       │   │
│  ├─────────────────────────────────────────────────────┤   │
│  │ 🟡 P1 - New Dependency Detected: Platform API       │   │
│  │     My Career Universe • 45m ago                     │   │
...
```
┌─────────────────────────────────────────────────────────────┐
│  Task Queue - My Career Universe                             │
├─────────────────────────────────────────────────────────────┤
│                                                               │
│  🔴 Urgent         🟡 Review Soon      🔵 Low Priority       │
│  (P0)              (P1)                (P2/P3)               │
│                                                               │
│  ┌──────────────┐  ┌──────────────┐  ┌──────────────┐      │
│  │ API Vendor   │  │ Exec Status  │  │ Backlog      │      │
│  │ EOL Risk     │  │ Report       │  │ Health Check │      │
│  │              │  │              │  │              │      │
│  │ 15m ago      │  │ 2h ago       │  │ 1d ago       │      │
│  │ [Review]     │  │ [Review]     │  │ [Review]     │      │
│  └──────────────┘  └──────────────┘  └──────────────┘      │
│                    ┌──────────────┐  ┌──────────────┐      │
│                    │ Meeting Prep │  │ Artefact     │      │
...
```
┌─────────────────────────────────────────────────────────────┐
│  Task Queue - My Career Universe              [Kanban|Table] │
├─────┬────────────────────┬──────┬─────────┬────────┬────────┤
│ Pri │ Task               │ Type │ Created │ Status │ Action │
├─────┼────────────────────┼──────┼─────────┼────────┼────────┤
│ 🔴  │ API Vendor EOL     │ Risk │ 15m ago │ Review │ [Open] │
│ 🟡  │ Exec Status Report │ Rep. │ 2h ago  │ Review │ [Open] │
│ 🟡  │ Meeting Prep       │ Prep │ 3h ago  │ Review │ [Open] │
│ 🟡  │ Dependency: API    │ Dep. │ 45m ago │ Review │ [Open] │
│ 🔵  │ Backlog Health     │ Main │ 1d ago  │ Review │ [Open] │
│ 🔵  │ Artefact Archive   │ Main │ 1d ago  │ Done   │ [View] │
└─────┴────────────────────┴──────┴─────────┴────────┴────────┘
```
...
```
┌─────────────────────────────────────────────────────────────┐
│  Agent Activity Stream                          [Live] [⏸️]   │
├─────────────────────────────────────────────────────────────┤
│                                                               │
│  🔴 11:47:23 - High Risk Detected                            │
│  My Career Universe                                           │
│  ├─ Read raid_log.md (detected R001: API vendor EOL)        │
│  ├─ Executed risk_escalation skill                           │
│  ├─ Generated escalation brief                               │
│  └─ ⚠️  Awaiting approval                                    │
│     [Review Brief]                                            │
│                                                               │
│  ──────────────────────────────────────────────────────────  │
│                                                               │
│  🟢 09:15:32 - Delivery State Updated                        │
│  My Career Universe                                           │
│  ├─ Jira sprint closed (Sprint 12)                          │
│  ├─ Updated delivery_state.md (32 points delivered)         │
│  └─ ✓ Auto-executed (logged)                                │
│                                                               │
│  ──────────────────────────────────────────────────────────  │
│                                                               │
│  🟡 09:00:15 - Exec Status Report Generated                  │
│  My Career Universe                                           │
│  ├─ Triggered by schedule (Monday 9am)                       │
│  ├─ Read delivery_state, RAID, milestones, decisions        │
│  ├─ Generated exec_status_report                             │
│  └─ ⚠️  Awaiting approval                                    │
│     [Review Report] [Approve] [Edit]                         │
│                                                               │
│  ──────────────────────────────────────────────────────────  │
│                                                               │
│  🔵 08:30:42 - Archived Resolved Risks                       │
│  My Career Universe                                           │
│  ├─ Detected 3 resolved risks in raid_log.md                │
│  ├─ Moved to archive/raid_log_archive.md                    │
│  └─ ✓ Auto-executed (logged)                                │
│                                                               │
└─────────────────────────────────────────────────────────────┘
```
...
│                                                               │
│  📁 Strategic                                                │
│  ├─ ✓ project_brief.md                  Updated: 2w ago    │
│  ├─ ✓ stakeholders.md                   Updated: 1w ago    │
│  └─ ✓ success_metrics.md                Updated: 3w ago    │
│                                                               │
│  📁 Risk and Dependencies                                    │
│  ├─ ⚠️  raid_log.md                     Updated: 15m ago   │
│  │   └─ 1 high risk, 2 medium risks                        │
│  ├─ ⚠️  dependencies.md                 Updated: 45m ago   │
│  │   └─ 1 blocker (Platform API access)                    │
│  └─ ✓ constraints.md                    Updated: 2w ago    │
│                                                               │
│  📁 Delivery Tracking                                        │
│  ├─ ✓ roadmap.md                        Updated: 1w ago    │
│  ├─ ✓ delivery_state.md                 Updated: 2h ago    │
│  │   └─ Sprint 12 complete, 32 points                      │
│  └─ ⚠️  backlog.md                      Updated: 1d ago    │
│      └─ 2 items need acceptance criteria                   │
│                                                               │
│  📁 Decisions                                                │
│  ├─ ✓ decisions.md                      Updated: 3d ago    │
│  │   └─ 12 decisions logged                                │
│  └─ 📁 adrs (2 records)                                     │
│                                                               │
│  📁 Outputs                                                  │
│  ├─ 📁 status_reports (23 reports)                          │
│  ├─ 📁 escalations (8 briefs)                               │
│  ├─ 📁 meeting_prep (15 briefs)                             │
│  └─ 📁 briefs (34 structured briefs)                        │
│                                                               │
└─────────────────────────────────────────────────────────────┘
```
...
```
┌─────────────────────────────────────────────────────────────┐
│  ⚠️  Review Required: API Vendor EOL Risk Escalation         │
├─────────────────────────────────────────────────────────────┤
│                                                               │
│  Task: Risk Escalation                                       │
│  Project: My Career Universe                                 │
│  Priority: 🔴 P0 (Critical)                                  │
│  Created: 2025-02-03 11:47:23 (15 minutes ago)               │
│  Skill: risk_escalation                                      │
│                                                               │
│  ──────────────────────────────────────────────────────────  │
│                                                               │
│  Agent Summary:                                              │
│  Detected high-severity risk in RAID log (R001: API vendor  │
│  EOL). Generated escalation brief for steering committee.    │
│  Decision needed on vendor migration approach.                │
│                                                               │
│  Context Used:                                               │
│  • raid_log.md (detected new high-severity risk)            │
│  • dependencies.md (checked for related dependencies)        │
│  • milestones.md (identified impact on March launch)         │
│  • decisions.md (checked for related vendor decisions)       │
│                                                               │
│  ──────────────────────────────────────────────────────────  │
│                                                               │
│  Generated Output:                                           │
│                                                               │
│  ┌─────────────────────────────────────────────────────────┐│
│  │ # Risk Escalation Brief - API Vendor EOL               ││
│  │                                                          ││
│  │ **Risk ID**: R001                                       ││
│  │ **Severity**: High                                      ││
│  │ **Detected**: 2025-02-03 11:45                          ││
│  │                                                          ││
│  │ ## Summary                                              ││
│  │ Current API vendor (Vendor A) announced end-of-life    ││
│  │ in June 2025. Migration to alternative vendor required ││
│  │ to maintain platform functionality. March 2025 launch  ││
│  │ timeline at risk.                                       ││
│  │                                                          ││
│  │ ## Impact                                               ││
│  │ - March launch may be delayed 2-4 weeks                ││
│  │ - Budget impact: $15-25k for migration                 ││
│  │ - Resource impact: 2 developers for 3 weeks            ││
│  │                                                          ││
│  │ ## Options                                              ││
│  │ 1. Migrate to Vendor B (recommended)                   ││
│  │    - Cost: ~$18k, Timeline: 3 weeks                    ││
│  │ 2. Evaluate alternative vendors                        ││
│  │    - Cost: TBD, Timeline: 4-5 weeks                    ││
│  │ 3. Delay launch, build custom solution                 ││
│  │    - Cost: $40k+, Timeline: 8 weeks                    ││
│  │                                                          ││
│  │ ## Recommendation                                       ││
│  │ Proceed with Vendor B migration. Initiate immediately  ││
│  │ to minimize launch delay. Adjust March timeline to     ││
│  │ mid-April.                                              ││
│  │                                                          ││
│  │ ## Stakeholders for Decision                            ││
│  │ - Sarah (Product Lead): Timeline approval              ││
│  │ - Finance: Budget approval                              ││
│  │ - Legal: Vendor contract approval                       ││
│  │ - Tom (CTO): Technical sign-off                         ││
│  └─────────────────────────────────────────────────────────┘│
│                                                               │
│  ──────────────────────────────────────────────────────────  │
│                                                               │
│  Actions:                                                    │
│  ┌────────────┐ ┌────────────┐ ┌────────────┐ ┌──────────┐ │
│  │ ✅ Approve │ │ ✏️  Edit    │ │ ❌ Reject  │ │ 💬 Notes │ │
│  └────────────┘ └────────────┘ └────────────┘ └──────────┘ │
│                                                               │
│  If approved, this brief will be:                            │
│  • Saved to /outputs/escalations/                            │
│  • Ready to send to steering committee                       │
│                                                               │
│  Comments/Notes:                                             │
│  ┌─────────────────────────────────────────────────────────┐│
│  │ [Add notes for agent learning or record decision...]    ││
│  └─────────────────────────────────────────────────────────┘│
│                                                               │
└─────────────────────────────────────────────────────────────┘
```
...
│  │  • Dashboard, Task Queue, Activity Stream            │  │
...
│  │  • /api/projects (CRUD)                              │  │
│  │  • /api/tasks (approval workflow)                    │  │
│  │  • /api/agent (trigger, status)                      │  │
...
│  • Agent logs, Integration configs (encrypted)              │
│  • Artefact metadata (files stored separately)              │
└────────────────────────┬────────────────────────────────────┘
                         │
                         ▼
┌─────────────────────────────────────────────────────────────┐
│                  FILE STORAGE (AWS S3 / Vercel Blob)         │
│  • Project artefacts (encrypted at rest)                    │
│  • Agent outputs (encrypted at rest)                        │
│  • Integration data cache (encrypted)                       │
│  • Encryption: AES-256, per-user keys                       │
└─────────────────────────────────────────────────────────────┘

┌─────────────────────────────────────────────────────────────┐
│         AGENT RUNTIME (AWS Lambda / Render / Railway)        │
│  ┌──────────────────────────────────────────────────────┐  │
│  │              Proactive Agent Service                  │  │
│  │  • Monitoring loop (15 min intervals)                │  │
│  │  • Condition detection                                │  │
│  │  • Skill execution                                    │  │
│  │  • Integration polling                                │  │
│  └──────────────────────────────────────────────────────┘  │
│  ┌──────────────────────────────────────────────────────┐  │
│  │              Integration Hub                          │  │
│  │  • Asana, Slack, Outlook, SharePoint, Jira, GitHub   │  │
│  │  • Credentials encrypted in database                  │  │
│  │  • Secure polling and event handling                  │  │
│  └──────────────────────────────────────────────────────┘  │
└────────────────────────┬────────────────────────────────────┘
                         │
                         ▼
...
│  • Read-only or write-with-approval                         │
└─────────────────────────────────────────────────────────────┘
```
...
```
┌─────────────────────────────────────────────────────────────┐
│                      RENDER (Agent Runtime)                  │
│  ┌──────────────────────────────────────────────────────┐  │
│  │  Agent Service (Node.js / Python)                    │  │
│  │  • Monitoring loop (every 15 minutes)                │  │
│  │  • Reads project configs from DB                     │  │
│  │  • Polls integrations (Asana, Slack, etc.)           │  │
│  │  • Detects trigger conditions                        │  │
│  │  • Executes Skills (calls Claude API)                │  │
│  │  • Writes outputs to S3                              │  │
│  │  • Updates DB (tasks, agent_actions)                 │  │
│  │  • Triggers Pusher events for real-time UI           │  │
│  └──────────────────────────────────────────────────────┘  │
└────────────────────────┬────────────────────────────────────┘
                         │
                         ├─> PostgreSQL (project configs, tasks)
                         ├─> S3 (artefacts, outputs)
                         ├─> Claude API (Skill execution)
                         ├─> Integrations (Asana, Slack, etc.)
...
**Render (Agent):**
- Push to `main` → Auto-deploy agent service
...
7. Test end-to-end: Agent detects condition → Creates task → Shows in UI → User approves
